...
export const SKILLS = [
    ...
    { id: 'fireRate', name: 'Fire Rate', description: 'Reduce weapon cooldown by 10%', maxPoints: 3, prerequisite: 'accuracy' },
    { id: 'thrusterPower', name: 'Thruster Power', description: 'Increase ship acceleration by 15%', maxPoints: 3, prerequisite: null },
