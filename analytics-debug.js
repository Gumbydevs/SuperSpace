...
window.analyticsDebugTracker = {
    ...
    trackCall: function(method, args) {
        ...
        console.log('🔥 ANALYTICS CALL:', method, args, 'window.analytics exists:', !!window.analytics);
...
if (window.analytics) {
    ...
    const checkInterval = setInterval(() => {
        checkCount++;
        if (window.analytics) {
            console.log(`🔥 ANALYTICS: window.analytics became available after ${checkCount * 100}ms`);
...
console.log('🔥 ANALYTICS DEBUG: Debug helper loaded. Use window.testAnalytics() to test manually.');
console.log('🔥 ANALYTICS DEBUG: Use window.analyticsDebugTracker.getCalls() to see all analytics calls.');