...
console.log(
  'First 5 disabled options:',
  Array.from(disabledOptions)
    .slice(0, 5)
    .map((el) => ({
...
const success = window.game.premiumStore.purchaseWithGems(
  'avatar',
  'astronaut_gold',
);
...
console.log(
  'Avatar manager owns astronaut_gold:',
  window.game.avatarManager.ownsAvatar('astronaut_gold'),
);
console.log(
  'Available avatars:',
  window.game.avatarManager.getAllAvailableAvatars(),
);
